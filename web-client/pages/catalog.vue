        ...
        <section class="grid grid-cols-12">
            ...
            <div class="lg:col-span-8 col-span-full bg-red-500 h-screen px-8 py-12 flex flex-col">
                ...
                <div class="flex flex-col gap-4">
                    <div v-for="(item, index) in catalogItems" :key="index" class="grid grid-cols-12 bg-white h-40 rounded-xl shadow-lg max-w-4xl text-gray-700 hover:bg-gray-100 cursor-pointer">
